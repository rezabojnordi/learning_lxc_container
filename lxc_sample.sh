...
Lxc file push myfile myvm:/root  ##-----> for send file to container

Lxc file pull myvm/root/myfile .  ##------->for get or download container to my local server
